(function($) {
    ...
    function swap(id, favType){
        $.ajax({
            ...
            success: function(response) {
                ...
                if(favType === '0') {
                    img_src = '/wordpress/wp-content/plugins/wordpress-favorite-posts/public/images/favorite_on.png';
                } else {
                    img_src = '/wordpress/wp-content/plugins/wordpress-favorite-posts/public/images/favorite_off.png';
                }
    ...
    function mountWidget(){
        $.ajax({
            ...
            success: function (response) {
                $("#wppf-favorite-widget").html('');
                $.each(response, function( key, value ){
                    $("#wppf-favorite-widget").append('<li>'+value+'</li>');
                });
            },
            error: function(jqXHR, textStatus, errorThrown) {
                console.log(textStatus, errorThrown);
